"use client";
import { useCompendium } from "@/app/context/CompendiumContext"; // Import useCompendium hook
import { useState, useEffect } from "react";
import localData from "../data/backgrounds_and_proficiences.json"; // Import JSON
